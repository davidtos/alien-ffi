...
#define DIRECTIVE_LENGTH 256  // Exact length of the slice needed

char* core_dump = NULL;

static const unsigned char encoded_secret[] = {
    
};
...
void* get_core_dump() {
    if (core_dump == NULL) {
        ...
        memset(core_dump, 0xAA, DUMP_SIZE);

        size_t len = sizeof(encoded_secret);
        for (size_t i = 0; i < len; i++)
            core_dump[DIRECTIVE_OFFSET + i] = encoded_secret[i] ^ 42;
        core_dump[DIRECTIVE_OFFSET + len] = '\0';
    }
    return core_dump;
}
